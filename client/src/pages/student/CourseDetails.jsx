...
  const {allCourses, calculateRating, calculateChapterTime, 
    calculateCourseDuration, calculateNOfLectures, currency, backendUrl, userData, getToken  } = useContext(AppContext)
...
                  <div className='flex'>
                    {/* **Safety check on coursesRatings is critical here** */}
...
  {/* **Added nullish coalescing for coursesRatings length** */}
  ({courseData.coursesRatings?.length ?? 0} {courseData.coursesRatings?.length > 1 ? 'ratings' : 'rating'})
</p>

                  <p>
  {/* **Added nullish coalescing for enrolledStudents length** */}
...
              {/* **Added optional chaining to courseContent** */}
...
                    </div>
                    {/* **Added optional chaining and nullish coalescing to chapterContent length** */}
                    <p className='text-sm md:text-sm'>{chapter.chapterContent?.length ?? 0} lectures - {calculateChapterTime(chapter)}</p>
                  </div>

                  <div className={`overflow-hidden transition-all duration-300 ${openSections[index] ? 'max-h-96' : 'max-h-0'} `}>
                    <ul className='list-disc md:pl-10 pl-4 pr-4 pr-4 py-2 py-2 text-gray-600 border-t border-gray-300'>
                      {/* **Added optional chaining to chapterContent** */}
...
                                videoId: lecture.lectureUrl?.split('/').pop() // Added optional chaining

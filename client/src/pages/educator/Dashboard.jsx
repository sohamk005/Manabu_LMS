...
import dummyDashboardData from '../../assets/dashboardData'
        ...
        <div className='space-y-5'>
          <div className='flex flex-wrap gap-5 items-center'>
            <div className='flex items-center gap-3 shadow-card border border-blue-500 p-4 w-56 rounded-md'>
              <img className='w-10 h-auto' src={assets.user} alt="patients_icon" />
              <div>
            ...
            <div className='flex items-center gap-3 shadow-card border border-blue-500 p-4 w-56 rounded-md'>
              <img className='w-10 h-auto' src={assets.lesson} alt="appointments_icon" />
              <div>
            ...
            <div className='flex items-center gap-3 shadow-card border border-blue-500 p-4 w-56 rounded-md'>
              <img className='w-10 h-auto' src={assets.earnings} alt="patients_icon" />
              <div>
